...
define([], function () {
   ...
   function ErrorMeter(r300, r100, r50) {
      ...
      let newiconpiece = function(name, pos) {
         ...
         piece.x = 0;
         piece.y = ((barheight * r300) / r50 + 35) * pos;
         return piece;
      };
   ...
   if (PIXI.Container) {
      ErrorMeter.__proto__ = PIXI.Container;
   }
   ErrorMeter.prototype = Object.create(
   ...
   if (PIXI.Container) {
      ErrorMeterOverlay.__proto__ = PIXI.Container;
   }
   ErrorMeterOverlay.prototype = Object.create(
      PIXI.Container && PIXI.Container.prototype
   );
