function setOptionPanel() {
  ...
  function checkdefault(element, item) {
    if (gamesettings[item] == defaultsettings[item]) element.parentElement.parentElement.parentElement.classList.remove("non-default");
    else element.parentElement.parentElement.parentElement.classList.add("non-default");
  }
  ...
  function bindkeyselector(id, keynameitem, keycodeitem) {
    ...
    let activate = function () {
      ...
      let listenkey = function (e) {
        ...
        if (gamesettings[keynameitem] == " ") gamesettings[keynameitem] = "SPACE";
        if (gamesettings[keynameitem] == "ESCAPE") gamesettings[keynameitem] = "ESC";
        if (gamesettings[keynameitem] == "CONTROL") gamesettings[keynameitem] = "CTRL";
